          ...
          <aside className="space-y-4">
            ...
            <div className="p-6 rounded-3xl bg-card border border-border">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                ...
                <li><a href="https://wa.me/2348036337497" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary"><MessageCircle className="w-4 h-4 text-primary" /> WhatsApp: 
                +2348036337497</a></li>
              </ul>
